...
do for [structf in '1 2']{
filename='check-scale-dep-f'.structf.'Wp-originalcode-singlet.ps'
set output filename
...
filepair(as)='<paste tmp-as'.as.'-singlet/'.base(xR1,xF1).' tmp-as'.as.'-singlet/'.base(xR2,xF2)
set log x
...
do for [structf in '1 2']{
filename='check-scale-dep-f'.structf.'Wm-originalcode-singlet.ps'
set output filename
...
do for [structf in '1 2']{
filename='check-scale-dep-f'.structf.'Z-originalcode-singlet.ps'
set output filename
