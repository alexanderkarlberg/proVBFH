...
filename='check-scale-dep-f'.structf.'Wp.ps'
set output filename
...
base(r,f)='hoppet-F'.structf.'WpmZ_mur'.r.'.0_muf'.f.'.0_scQ.dat'
filepair(as)='<paste tmp-as'.as.'/'.base(xR1,xF1).' tmp-as'.as.'/'.base(xR2,xF2)
set log x
...
do for [structf in '1 2 3']{
filename='check-scale-dep-f'.structf.'Wm.ps'
set output filename
...
do for [structf in '1 2 3']{
filename='check-scale-dep-f'.structf.'Z.ps'
set output filename
