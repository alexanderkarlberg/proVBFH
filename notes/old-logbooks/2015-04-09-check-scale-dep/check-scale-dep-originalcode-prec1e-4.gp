...
filename='check-scale-dep-f'.structf.'Wp-originalcode-prec1e-4.ps'
set output filename
...
filepair(as)='<paste tmp-as'.as.'-prec1e-4/'.base(xR1,xF1).' tmp-as'.as.'-prec1e-4/'.base(xR2,xF2)
set log x
...
do for [structf in '1 2 3']{
filename='check-scale-dep-f'.structf.'Wm-originalcode-prec1e-4.ps'
set output filename
...
do for [structf in '1 2 3']{
filename='check-scale-dep-f'.structf.'Z-originalcode-prec1e-4.ps'
set output filename
