...
filename='check-scale-dep-f'.structf.'Wp-originalcode.ps'
set output filename
...
do for [structf in '1 2 3']{
filename='check-scale-dep-f'.structf.'Wm-originalcode.ps'
set output filename
...
do for [structf in '1 2 3']{
filename='check-scale-dep-f'.structf.'Z-originalcode.ps'
set output filename
