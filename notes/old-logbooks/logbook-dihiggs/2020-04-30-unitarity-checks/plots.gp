...
set yrange [*:*]
iindex=2
plot fn_TT i iindex u   (($1+$2)/2.):3:4 w e lw 2 lc rgb ColTT ti LabTT,\
     fn_BB i iindex u   (($1+$2)/2.):3:4 w e lw 2 lc rgb ColBB ti LabBB,\
     fn_TB i iindex u   (($1+$2)/2.):3:4 w e lw 2 lc rgb ColTB ti LabTB,\
     fn_full i iindex u (($1+$2)/2.):3:4 w e lw 2 lc rgb ColFull ti LabFull
