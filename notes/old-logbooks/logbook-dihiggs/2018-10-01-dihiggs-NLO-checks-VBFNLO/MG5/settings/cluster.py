...
class CondorCluster(Cluster):
    ...
    @store_input()
    @multiple_try()
    def submit2(self, prog, argument=[], cwd=None, stdout='/afs/cern.ch/user/f/frdreyer/o.log', stderr='/afs/cern.ch/user/f/frdreyer/e.log', 
                log='/afs/cern.ch/user/f/frdreyer/l.log', input_files=[], output_files=[], required_output=[], 
                nb_submit=0):
        ...
        if self.cluster_queue not in ['None', None]:
            ...
            requirement = 'requirements = (OpSysAndVer =?= "CentOS7")'
