...
set label 2001 '{/*0.8Q_i/2 < {/Symbol m}_{R,i} , {/Symbol m}_{F,i} < 2 Q_i' at graph 0.98,0.84 right
...
unset label 2001
unset label 2002
set ylabel 'ratio to {/Symbol k}=1 N^{3}LO' offset 1,0
set format x
...
set label 2000 '{/*0.8PDF4LHC15\_nnlo\_mc' at graph 0.98,0.84 right
set label 2001 '{/*0.8Q_i/2 < {/Symbol m}_{R,i} , {/Symbol m}_{F,i} < 2 Q_i' at graph 0.98,0.75 right
set label 2002 '{/*0.8HE-LHC 27 TeV' at graph 0.98,0.93 right
set yrange [0:4.0]
set xtics format ""
#set logscale y
...
set label 2001 '{/*0.8Q_i/2 < {/Symbol m}_{R,i} , {/Symbol m}_{F,i} < 2 Q_i' at graph 0.98,0.16 right
