...
do for [type in '0 1 2 3 4 5 6 0-LO 1-LO 2-LO 3-LO 4-LO 5-LO 6-LO'] {
...
set title '11, 22 (NLO)'
plot '< exec bash -c "paste <(mergeidx.pl -f '.type.'.top \"sig wrong 2 jets-11\") <(mergeidx.pl -f '.type.'.top \"sig tot 2 jets-11\")"' u (($1+$2)/2):($3/$7):(@calcerr) w errorl ti '2 jets, 11',\
     '< exec bash -c "paste <(mergeidx.pl -f '.type.'.top \"sig wrong 2 jets-22\") <(mergeidx.pl -f '.type.'.top \"sig tot 2 jets-22\")"' u (($1+$2)/2):($3/$7):(@calcerr) w errorl ti '2 jets, 22',\
     '< exec bash -c "paste <(mergeidx.pl -f '.type.'.top \"sig wrong 3 jets-11\") <(mergeidx.pl -f '.type.'.top \"sig tot 3 jets-11\")"' u (($1+$2)/2):($3/$7):(@calcerr) w errorl ti '3 jets, 11',\
...
set title '12, 21 (NLO)'
plot '< exec bash -c "paste <(mergeidx.pl -f '.type.'.top \"sig wrong 2 jets-12\") <(mergeidx.pl -f '.type.'.top \"sig tot 2 jets-12\")"' u (($1+$2)/2):($3/$7):(@calcerr) w errorl ti '2 jets, 12',\
     '< exec bash -c "paste <(mergeidx.pl -f '.type.'.top \"sig wrong 2 jets-21\") <(mergeidx.pl -f '.type.'.top \"sig tot 2 jets-21\")"' u (($1+$2)/2):($3/$7):(@calcerr) w errorl ti '2 jets, 21',\
     '< exec bash -c "paste <(mergeidx.pl -f '.type.'.top \"sig wrong 3 jets-12\") <(mergeidx.pl -f '.type.'.top \"sig tot 3 jets-12\")"' u (($1+$2)/2):($3/$7):(@calcerr) w errorl ti '3 jets, 12',\
...
set title '11, 22 (NLO)'
plot '<mergeidx.pl -f '.type.'.top "sig wrong 2 jets-11"' u (($1+$2)/2):($3):($4) w errorl ti '2 jets, 11',\
     '<mergeidx.pl -f '.type.'.top "sig wrong 2 jets-22"' u (($1+$2)/2):($3):($4) w errorl ti '2 jets, 22',\
     '<mergeidx.pl -f '.type.'.top "sig wrong 3 jets-11"' u (($1+$2)/2):($3):($4) w errorl ti '3 jets, 11',\
...
set title '12, 21 (NLO)'
plot '<mergeidx.pl -f '.type.'.top "sig wrong 2 jets-12"' u (($1+$2)/2):($3):($4) w errorl ti '2 jets, 12',\
     '<mergeidx.pl -f '.type.'.top "sig wrong 2 jets-21"' u (($1+$2)/2):($3):($4) w errorl ti '2 jets, 21',\
     '<mergeidx.pl -f '.type.'.top "sig wrong 3 jets-12"' u (($1+$2)/2):($3):($4) w errorl ti '3 jets, 12',\
...
set title '11, 22 (NLO)'
plot '<mergeidx.pl -f '.type.'.top "sig tot 2 jets-11"' u (($1+$2)/2):($3):($4) w errorl ti '2 jets, 11',\
     '<mergeidx.pl -f '.type.'.top "sig tot 2 jets-22"' u (($1+$2)/2):($3):($4) w errorl ti '2 jets, 22',\
     '<mergeidx.pl -f '.type.'.top "sig tot 3 jets-11"' u (($1+$2)/2):($3):($4) w errorl ti '3 jets, 11',\
...
set title '12, 21 (NLO)'
plot '<mergeidx.pl -f '.type.'.top "sig tot 2 jets-12"' u (($1+$2)/2):($3):($4) w errorl ti '2 jets, 12',\
     '<mergeidx.pl -f '.type.'.top "sig tot 2 jets-21"' u (($1+$2)/2):($3):($4) w errorl ti '2 jets, 21',\
     '<mergeidx.pl -f '.type.'.top "sig tot 3 jets-12"' u (($1+$2)/2):($3):($4) w errorl ti '3 jets, 12',\
