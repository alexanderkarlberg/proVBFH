c     
      ...
      integer nleg, i, mu,j, ig
      parameter (nleg=nlegreal)
      real * 8 p(0:3,nleg)
      integer rflav(nleg)
      real * 8 amp2         
      integer rflav_check(nleg),k
...
C*******************  q1 q3 ---> q2 q4 g g H   **********************
      ...
      physToDiag(1)=1    !physToDiag(1/3) are labels of incoming quarks
      physToDiag(2)=3
      physToDiag(3)=2    !physToDiag(2/4) are labels of outgoing quarks.
      physToDiag(4)=4
...
c up- or down-type quark:      
      ...
      if ((ftype(1).eq.ftype(4))) then !nc
         ...
         print*,'this qb qb flav combination is not implemented'
         print*,'rflav=',bflav
         stop
...
c up- or down-type quark:      
      ...
      if ((ftype(1).eq.ftype(4))) then !nc
         ...
         print*,'(b) this qb g flav combination is not implemented'
         print*,'rflav=',bflav
         stop
...
c up- or down-type quark:      
      ...
      if ((ftype(1).eq.ftype(4))) then !nc
         ...
         print*,'this flav combination is not implemented for g=p6'
         print*,'rflav=',bflav
         stop
...
c up- or down-type quark:      
      ...
      ftype(5) = 2-mod(abs(bflav(7)),2)
         ...
         print*,'this gg flav combination is not implemented'
         print*,'rflav=',bflav
         stop
