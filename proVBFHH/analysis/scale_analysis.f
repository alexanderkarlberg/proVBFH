...
c  You can substitute these with your favourite ones
      ...
      call bookupeqbins('ptHH',10d0, 0d0, 400d0)

      call bookupeqbins('minQ1Q2',10d0, 0d0, 400d0)
      call bookupeqbins('maxQ1Q2',10d0, 0d0, 400d0)
      call bookupeqbins('sqrtQ1Q2',10d0, 0d0, 400d0)
      call bookupeqbins('sqrtMTH1MTH2',10d0, 0d0, 400d0)
      call bookupeqbins('mjj',10d0, 0d0, 400d0)
      call bookupeqbins('sqrtptj1ptj2',10d0, 0d0, 400d0)
      call bookupeqbins('mH1H2',10d0, 0d0, 400d0)
...
c arrays to reconstruct jets
      ...
      integer  k, j
      real * 8 pH1(0:3),pH2(0:3),pj(0:3,4), Q1(0:3), Q2(0:3), Q1val,
     $     Q2val, minQ1Q2, maxQ1Q2, sqrtQ1Q2, mH1, mH2, MTH1, MTH2,
     $     mH1H2
...
c     Higgs momentum
      ...
      mTH1 = sqrt(mH1**2+(pH1(1)+pH1(2))**2)
      mTH2 = sqrt(mH2**2+(pH2(1)+pH2(2))**2)
      Q1val = sqrt(abs((Q1(0)**2 - Q1(1)**2 - Q1(2)**2 - Q1(3)**2)))
      Q2val = sqrt(abs((Q2(0)**2 - Q2(1)**2 - Q2(2)**2 - Q2(3)**2)))
      !print*, 'Q1val, Q2val = ', Q1val, Q2val
      minQ1Q2  = min(Q1val, Q2val)
      maxQ1Q2  = max(Q1val, Q2val)
      sqrtQ1Q2 = sqrt(Q1val*Q2val)
      
      call filld('ptHH',ptHH,dsig)
      call filld('minQ1Q2',ptHH,dsig*minQ1Q2)
      call filld('maxQ1Q2',ptHH,dsig*maxQ1Q2)
      call filld('sqrtQ1Q2',ptHH,dsig*sqrtQ1Q2)
      call filld('sqrtptj1ptj2',ptHH,dsig*sqrt(ptj(1)*ptj(2)))
      call filld('sqrtMTH1MTH2',ptHH,dsig*sqrt(mTH1*mTH2))
      call filld('mjj',ptHH,dsig*invmjj)
      call filld('mH1H2',ptHH,dsig*mH1H2)
