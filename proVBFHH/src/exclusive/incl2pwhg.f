...
!      print*, 'incl_tot', incl_tot, www, brkn_jacborn
      ...
      vpH1(0) = p(4,3)
      vpH2(0) = p(4,4)
      ptH1H2 = sqrt((p(1,3)+p(1,4))**2 + (p(2,3)+p(2,4))**2) 

      vq1(1:3) = p(1:3,5) - p(1:3,1) 
      vq2(1:3) = p(1:3,6) - p(1:3,2) 
      vq1(0) = p(4,5) - p(4,1) 
      vq2(0) = p(4,6) - p(4,2) 
