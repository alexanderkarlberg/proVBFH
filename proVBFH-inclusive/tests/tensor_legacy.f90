! Reference copy of the tensor module as it was before the
! allocation-free rewrite (proVBFH-inclusive/src/tensor.f90 at
! 1326b19; the proVBFHH copy differed only by a typo in a comment, the
! proVBFH copy used the general-metric form of raise/lower, which is
! equivalent for the diagonal metric set by SetMetric). It is kept
! unchanged, apart from the module name, as the oracle for
! tests/test_tensor.f90. It is not part of the build of the programs.
!
